        ...
        <form wire:submit.prevent="updateSettings">
            ...
            <div class="grid grid-cols-1 gap-5">
                ...
                <div>
                    ...
                    <x-ui.input 
                        type="text" 
                        placeholder="{{ __('Enter your RapidAPI key') }}" 
                ...
                <div class="pt-5 mt-3 ">
                    ...
                    <div class="space-y-4">
                        @forelse($form->featured_users as $index => $user)
                            <div 
                                wire:key="featured-user-{{ $index }}-{{ $loop->iteration }}" 
                                class=""
                            >
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <x-ui.input 
                                            type="text" 
                                            placeholder="{{ __('e.g., diodioglowskin') }}" 
                                    ...
                                    <div>
                                        ...
                                        <x-ui.input 
                                            type="text" 
                                            placeholder="{{ __('e.g., Diodio Glow Skin') }}" 
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <x-ui.input 
                                ...
                                min="1" 
                                max="50" 
                                wire:model.defer="form.videos_per_page" 
                            />
