            ...
            @if (!$loading && count($videos) > 0)
                ...
                @if ($this->shouldShowPagination())
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mt-12 px-4">
                            ...
                            <div class="hidden md:flex items-center gap-2">
                                ...
                                @if ($start > 1)
                                    <button wire:click="goToPage(1)"
                                        class="px-3 py-2 rounded-lg border border-second-500/30 bg-white hover:bg-second-50 text-text-primary font-medium transition-all duration-300">1</button>
                                    @if ($start > 2)
                                ...
                                @if ($end < $totalPages)
                                    ...
                                    <button wire:click="goToPage({{ $totalPages }})"
                                        class="px-3 py-2 rounded-lg border border-second-500/30 bg-white hover:bg-second-50 text-text-primary font-medium transition-all duration-300">{{ $totalPages }}</button>
                                @endif
                            </div>
                        ...
                        <div wire:loading wire:target="nextPage,previousPage,goToPage,setUser"
