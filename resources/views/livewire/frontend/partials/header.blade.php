<header x-data="{ mobileMenuOpen: false }" x-cloak class="sticky top-0 z-50 bg-white">
    <div class="container-wide flex items-center justify-between py-3 px-6">
        ...
        <nav class="hidden md:flex items-center gap-8">
            ...
            <a href="{{ route('f.products') }}" wire:navigate
                class="text-text-muted font-inter transition-colors {{ request()->routeIs('f.products') ? 'text-second-500 border-b-2 border-second-500' : 'hover:text-second-500 hover:border-b-2 hover:border-second-500' }}">
                {{ __('Products') }}
            </a>
